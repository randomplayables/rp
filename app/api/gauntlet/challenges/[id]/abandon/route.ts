...
//     return NextResponse.json({ success: true, message: "Challenge abandoned. Opponent awarded points." }, { headers: corsHeaders });

//   } catch (error: any) {
//     await session.abortTransaction();
//     console.error(`Error abandoning gauntlet challenge ${id}:`, error);
//     return NextResponse.json({ error: "Failed to abandon challenge", details: error.message }, { status: 500, headers: corsHeaders });
//   } finally {
//     session.endSession();
//   }
// }
