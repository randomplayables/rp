      ...
      <div className="w-full max-w-7xl flex flex-col md:flex-row bg-white shadow-lg rounded-lg overflow-hidden">
        ...
        <div className="w-full md:w-2/3 lg:w-2/3 p-6 bg-white">
          <div className="flex justify-between items-center mb-4">
            <h2 className="text-2xl font-bold text-emerald-700">Game Code</h2>
          ...
          <div className="bg-gray-50 p-4 rounded-lg">
            ...
            <ol className="list-decimal list-inside space-y-2 text-sm">
              ...
              <li>You can download the code and customize it further</li>
              <li>Test your game using the sandbox environment</li>
              <li>When ready, your game can be deployed to RandomPlayables</li>
            </ol>
          </div>
        </div>
      </div>
