export const API_CREDIT_LIMITS = {
    free: 10,
    premium: 500,
    premium_plus: 1500,
  };
  
  export function getApiLimitForTier(tier?: string | null): number {
    switch (tier) {
      case 'premium':
        return API_CREDIT_LIMITS.premium;
      case 'premium_plus':
        return API_CREDIT_LIMITS.premium_plus;
      default:
        return API_CREDIT_LIMITS.free;
    }
  }
